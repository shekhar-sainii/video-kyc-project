                ...
                <div className="flex items-center gap-3">
                  {app.status === "Pending" ? (
                    <button 
                      ...
                      className="flex-1 lg:flex-none flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.1em] shadow-lg shadow-indigo-500/20 transition-all active:scale-95"
                    >
